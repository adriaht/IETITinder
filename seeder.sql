...
INSERT INTO users (email, password, name, surname, alias, birth_date, latitude, longitude, sex, sexual_orientation, last_login_date, creation_date, distance_user_preference, min_age_user_preference, max_age_user_preference)
VALUES
('johndoe1@ieti.site', SHA2('password1', 512), 'John', 'Doe', 'johndoe1', '1995-01-01', 40.7128, -74.0060, 'home', 'heterosexual', '2025-01-01 08:15:32', '2025-01-01 08:15:32', 200, 18, 50),
('janesmith2@ieti.site', SHA2('password2', 512), 'Jane', 'Smith', 'janesmith2', '1994-02-02', 41.9028, 12.4964, 'dona', 'homosexual', '2025-01-02 09:20:14', '2025-01-02 09:20:14', 200, 18, 50),
('michaelbrown3@ieti.site', SHA2('password3', 512), 'Michael', 'Brown', 'michaelbrown3', '1990-03-03', 34.0522, -118.2437, 'home', 'bisexual', '2025-01-03 10:25:45', '2025-01-03 10:25:45', 200, 18, 50),
('emilyjones4@ieti.site', SHA2('password4', 512), 'Emily', 'Jones', 'emilyjones4', '1992-04-04', 51.5074, -0.1278, 'dona', 'heterosexual', '2025-01-04 11:30:21', '2025-01-04 11:30:21', 200, 18, 50),
('davidwhite5@ieti.site', SHA2('password5', 512), 'David', 'White', 'davidwhite5', '1989-05-05', 48.8566, 2.3522, 'home', 'bisexual', '2025-01-05 12:35:11', '2025-01-05 12:35:11', 200, 18, 50),
('sophiadavis6@ieti.site', SHA2('password6', 512), 'Sophia', 'Davis', 'sophiadavis6', '1993-06-06', 37.7749, -122.4194, 'dona', 'heterosexual', '2025-01-06 13:40:00', '2025-01-06 13:40:00', 200, 18, 50),
('jamesmiller7@ieti.site', SHA2('password7', 512), 'James', 'Miller', 'jamesmiller7', '1991-07-07', 40.7306, -73.9352, 'home', 'homosexual', '2025-01-07 14:45:22', '2025-01-07 14:45:22', 200, 18, 50),
('oliviagarcia8@ieti.site', SHA2('password8', 512), 'Olivia', 'Garcia', 'oliviagarcia8', '1990-08-08', 39.9526, -75.1652, 'dona', 'bisexual', '2025-01-08 15:50:35', '2025-01-08 15:50:35', 200, 18, 50),
('williammartinez9@ieti.site', SHA2('password9', 512), 'William', 'Martinez', 'williammartinez9', '1988-09-09', 52.5200, 13.4050, 'home', 'heterosexual', '2025-01-09 16:55:18', '2025-01-09 16:55:18', 200, 18, 50),
('avahernandez10@ieti.site', SHA2('password10', 512), 'Ava', 'Hernandez', 'avahernandez10', '1996-10-10', 34.0522, -118.2437, 'dona', 'bisexual', '2025-01-10 17:00:12', '2025-01-10 17:00:12', 200, 18, 50),
('liamlopez11@ieti.site', SHA2('password11', 512), 'Liam', 'Lopez', 'liamlopez11', '1992-11-11', 40.7306, -73.9352, 'home', 'heterosexual', '2025-01-11 18:05:23', '2025-01-11 18:05:23', 200, 18, 50),
('isabellagonzalez12@ieti.site', SHA2('password12', 512), 'Isabella', 'Gonzalez', 'isabellagonzalez12', '1989-12-12', 41.9028, 12.4964, 'dona', 'homosexual', '2025-01-12 19:10:34', '2025-01-12 19:10:34', 200, 18, 50),
('ethanwilson13@ieti.site', SHA2('password13', 512), 'Ethan', 'Wilson', 'ethanwilson13', '1995-01-13', 37.7749, -122.4194, 'home', 'bisexual', '2025-01-13 20:15:45', '2025-01-13 20:15:45', 200, 18, 50),
('miaanderson14@ieti.site', SHA2('password14', 512), 'Mia', 'Anderson', 'miaanderson14', '1991-02-14', 40.7128, -74.0060, 'dona', 'heterosexual', '2025-01-14 21:20:56', '2025-01-14 21:20:56', 200, 18, 50),
('noahthomas15@ieti.site', SHA2('password15', 512), 'Noah', 'Thomas', 'noahthomas15', '1987-03-15', 34.0522, -118.2437, 'home', 'bisexual', '2025-01-15 22:25:02', '2025-01-15 22:25:02', 200, 18, 50),
('aidenjackson16@ieti.site', SHA2('password16', 512), 'Aiden', 'Jackson', 'aidenjackson16', '1994-04-16', 41.9028, 12.4964, 'home', 'heterosexual', '2025-01-16 23:30:13', '2025-01-16 23:30:13', 200, 18, 50),
('ameliamartinez17@ieti.site', SHA2('password17', 512), 'Amelia', 'Martinez', 'ameliamartinez17', '1993-05-17', 37.7749, -122.4194, 'dona', 'homosexual', '2025-01-17 00:35:24', '2025-01-17 00:35:24', 200, 18, 50),
('lucasbrown18@ieti.site', SHA2('password18', 512), 'Lucas', 'Brown', 'lucasbrown18', '1996-06-18', 51.5074, -0.1278, 'home', 'bisexual', '2025-01-18 01:40:35', '2025-01-18 01:40:35', 200, 18, 50),
('charlottegarcia19@ieti.site', SHA2('password19', 512), 'Charlotte', 'Garcia', 'charlottegarcia19', '1995-07-19', 40.7306, -73.9352, 'dona', 'heterosexual', '2025-01-19 02:45:46', '2025-01-19 02:45:46', 200, 18, 50),
('sebastianlee20@ieti.site', SHA2('password20', 512), 'Sebastian', 'Lee', 'sebastianlee20', '1990-08-20', 39.9526, -75.1652, 'home', 'bisexual', '2025-01-20 03:50:57', '2025-01-20 03:50:57', 200, 18, 50),
('jackharris21@ieti.site', SHA2('password21', 512), 'Jack', 'Harris', 'jackharris21', '1988-09-21', 40.7128, -74.0060, 'home', 'heterosexual', '2025-01-21 04:55:08', '2025-01-21 04:55:08', 200, 18, 50),
('harperclark22@ieti.site', SHA2('password22', 512), 'Harper', 'Clark', 'harperclark22', '1997-10-22', 34.0522, -118.2437, 'dona', 'homosexual', '2025-01-22 05:00:19', '2025-01-22 05:00:19', 200, 18, 50),
('benjaminlewis23@ieti.site', SHA2('password23', 512), 'Benjamin', 'Lewis', 'benjaminlewis23', '1991-11-23', 41.9028, 12.4964, 'home', 'heterosexual', '2025-01-23 06:05:30', '2025-01-23 06:05:30', 200, 18, 50),
('lilywalker24@ieti.site', SHA2('password24', 512), 'Lily', 'Walker', 'lilywalker24', '1994-12-24', 37.7749, -122.4194, 'dona', 'bisexual', '2025-01-24 07:10:41', '2025-01-24 07:10:41', 200, 18, 50),
('danielyoung25@ieti.site', SHA2('password25', 512), 'Daniel', 'Young', 'danielyoung25', '1987-01-25', 40.7306, -73.9352, 'home', 'bisexual', '2025-01-25 08:15:52', '2025-01-25 08:15:52', 200, 18, 50),
('evelynking26@ieti.site', SHA2('password26', 512), 'Evelyn', 'King', 'evelynking26', '1990-02-26', 51.5074, -0.1278, 'dona', 'heterosexual', '2025-01-26 09:20:03', '2025-01-26 09:20:03', 200, 18, 50),
('jacobscott27@ieti.site', SHA2('password27', 512), 'Jacob', 'Scott', 'jacobscott27', '1992-03-27', 34.0522, -118.2437, 'home', 'homosexual', '2025-01-27 10:25:14', '2025-01-27 10:25:14', 200, 18, 50),
('chloegreen28@ieti.site', SHA2('password28', 512), 'Chloe', 'Green', 'chloegreen28', '1993-04-28', 40.7306, -73.9352, 'dona', 'bisexual', '2025-01-28 11:30:25', '2025-01-28 11:30:25', 200, 18, 50),
('masonadams29@ieti.site', SHA2('password29', 512), 'Mason', 'Adams', 'masonadams29', '1991-05-29', 39.9526, -75.1652, 'home', 'heterosexual', '2025-01-29 12:35:36', '2025-01-29 12:35:36', 200, 18, 50),
('zoebaker30@ieti.site', SHA2('password30', 512), 'Zoe', 'Baker', 'zoebaker30', '1988-06-30', 41.9028, 12.4964, 'dona', 'bisexual', '2025-01-30 13:40:47', '2025-01-30 13:40:47', 200, 18, 50),
('williamnelson31@ieti.site', SHA2('password31', 512), 'William', 'Nelson', 'williamnelson31', '1990-07-01', 40.7128, -74.0060, 'no binari', 'heterosexual', '2025-01-31 14:45:58', '2025-01-31 14:45:58', 200, 18, 50),
('amoscarter32@ieti.site', SHA2('password32', 512), 'Amos', 'Carter', 'amoscarter32', '1994-08-02', 34.0522, -118.2437, 'no binari', 'bisexual', '2025-02-01 15:50:09', '2025-02-01 15:50:09', 200, 18, 50),
('isabellamorris33@ieti.site', SHA2('password33', 512), 'Isabella', 'Morris', 'isabellamorris33', '1991-09-03', 51.5074, -0.1278, 'no binari', 'homosexual', '2025-02-02 16:55:20', '2025-02-02 16:55:20', 200, 18, 50),
('henrymitchell34@ieti.site', SHA2('password34', 512), 'Henry', 'Mitchell', 'henrymitchell34', '1992-10-04', 37.7749, -122.4194, 'no binari', 'heterosexual', '2025-02-03 17:00:31', '2025-02-03 17:00:31', 200, 18, 50),
('charlotteperez35@ieti.site', SHA2('password35', 512), 'Charlotte', 'Perez', 'charlotteperez35', '1996-11-05', 40.7306, -73.9352, 'no binari', 'bisexual', '2025-02-04 18:05:42', '2025-02-04 18:05:42', 200, 18, 50),
('elijahroberts36@ieti.site', SHA2('password36', 512), 'Elijah', 'Roberts', 'elijahroberts36', '1989-12-06', 39.9526, -75.1652, 'no binari', 'heterosexual', '2025-02-05 19:10:53', '2025-02-05 19:10:53', 200, 18, 50),
('auroraramirez37@ieti.site', SHA2('password37', 512), 'Aurora', 'Ramirez', 'auroraramirez37', '1994-01-07', 41.9028, 12.4964, 'no binari', 'bisexual', '2025-02-06 20:15:04', '2025-02-06 20:15:04', 200, 18, 50),
('jackharris38@ieti.site', SHA2('password38', 512), 'Jack', 'Harris', 'jackharris38', '1992-02-08', 40.7128, -74.0060, 'no binari', 'heterosexual', '2025-02-07 21:20:15', '2025-02-07 21:20:15', 200, 18, 50),
('liammorris39@ieti.site', SHA2('password39', 512), 'Liam', 'Morris', 'liammorris39', '1993-03-09', 34.0522, -118.2437, 'no binari', 'bisexual', '2025-02-08 22:25:26', '2025-02-08 22:25:26', 200, 18, 50),
('ellakim40@ieti.site', SHA2('password40', 512), 'Ella', 'Kim', 'ellakim40', '1995-04-10', 51.5074, -0.1278, 'no binari', 'heterosexual', '2025-02-09 23:30:37', '2025-02-09 23:30:37', 200, 18, 50),
('sophiahughes41@ieti.site', SHA2('password41', 512), 'Sophia', 'Hughes', 'sophiahughes41', '1988-05-11', 37.7749, -122.4194, 'no binari', 'bisexual', '2025-02-10 00:35:48', '2025-02-10 00:35:48', 200, 18, 50),
('oliverbennett42@ieti.site', SHA2('password42', 512), 'Oliver', 'Bennett', 'oliverbennett42', '1996-06-12', 40.7306, -73.9352, 'no binari', 'heterosexual', '2025-02-11 01:40:59', '2025-02-11 01:40:59', 200, 18, 50),
('ameliabaker43@ieti.site', SHA2('password43', 512), 'Amelia', 'Baker', 'ameliabaker43', '1990-07-13', 39.9526, -75.1652, 'no binari', 'bisexual', '2025-02-12 02:45:10', '2025-02-12 02:45:10', 200, 18, 50),
('logancook44@ieti.site', SHA2('password44', 512), 'Logan', 'Cook', 'logancook44', '1992-08-14', 41.9028, 12.4964, 'no binari', 'heterosexual', '2025-02-13 03:50:21', '2025-02-13 03:50:21', 200, 18, 50),
